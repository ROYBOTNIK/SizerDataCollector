	...
	public sealed class CollectorSettingsProvider
	{
		...
		private static CollectorRuntimeSettings BuildFromCollectorConfig()
		{
			...
			return new CollectorRuntimeSettings
			{
				...
				AnomalyMinLaneFpm = config.AnomalyMinLaneFpm,
				AnomalyMinPeerLaneFpm = config.AnomalyMinPeerLaneFpm,
				AnomalyMinActivePeerLanes = config.AnomalyMinActivePeerLanes,
				AnomalyMinConsecutiveWindows = config.AnomalyMinConsecutiveWindows,
