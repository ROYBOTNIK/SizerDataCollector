-- V019__fix_minute_quality_view_qv1_old.sql
-- Fixes V017 which was recorded with an incorrect checksum (transaction wrapper issue).
-- Recreates the view without relying on BEGIN/COMMIT.
